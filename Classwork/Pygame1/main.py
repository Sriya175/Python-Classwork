...
backround_image = pygame.transform.scale(
    pygame.image.load("\Users\sreedeviviswambaran\Documents\Python\Classwork\Pygame1\main.webp").convert(),
    (SCREEN_WIDTH, SCREEN_HIGHT))

penguin_image = pygame.transform.scale(
    pygame.image.load("\Users\sreedeviviswambaran\Documents\Python\Classwork\Pygame1\download.jpeg").convert_alpha(), (200, 200))
penguin_rect = penguin_image.get_rect(center=(SCREEN_WIDTH//2, 
    SCREEN_HIGHT//2-30))

text = pygame.font.Font(None, 36).render("Hello World", True,
    pygame.Color("black"))
text_rect = text.get_rect(center = (SCREEN_WIDTH//2, SCREEN_HIGHT//2+
110))
