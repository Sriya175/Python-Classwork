...
try: df = pd.read_csv("//Users//sreedeviviswambaran//Documents//Python//Classwork//Movie recomendation//imdb_top_1000.csv")
...
def recommend(genre=None, mood=None, rating=None, n=5):
    ...
    if d.empty:return "No suitable movie recomendations found"
    ...
    return out if out else "No suitable movie recomendation found"

def show(recs, name):
    print(Fore.YELLOW + f"\nAI-Analyzed Movie Reccommendations for {name}: ")
...
print(Fore.BLUE + "Welcome to your main movie Reccomendation Assistant! \n")
