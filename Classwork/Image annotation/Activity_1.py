...
image_path = "//Users//sreedeviviswambaran//Documents//Python//Classwork//Image annotation//Screenshot 2025-08-25 at 7.47.48 PM.png"
...
cv2.putText(image_rgb, "region 1", (top_left1[0], top_left1[1]-10), font, 0.7, (0,255,0), 2, cv2.LINE_AA)

cv2.putText(image_rgb, "region 2", (top_left2[0], top_left2[1]-10), font, 0.7, (0,255,0), 2, cv2.LINE_AA)
...
cv2.putText(image_rgb, f'Height: {height}px', height_label_position, font, 0.8, (255, 255, 0), 2, cv2.INTER_LINEAR_EXACT)
plt.figure(figsize = (12,8))
plt.imshow(image_rgb)
plt.title("Anotated Image with Regions, Centers, and Bi-Directional Height Arrows")
plt.axis("off")
plt.show()